...
MODELS = {
  "hair_segmentation": {
      ...
      "path": Path(".") / Path("hair_segmenter.tflite"),
      "img_size": 512,
      "masks": ["hair", "other"]
  },
  "multiclass_segmentation": {
      ...
      "path": Path(".") / Path("selfie_multiclass_256x256.tflite"),
      "img_size": 256,
      "masks": ["background", "hair", "body_skin", "face_skin", "clothes", "other"]
  },
  "face_landmarks": {
      "URL":  "https://storage.googleapis.com/mediapipe-models/face_landmarker/face_landmarker/float16/1/face_landmarker.task",
      "path": Path(".") / Path("face_landmarker_v2_with_blendshapes.task")
  }
}
...
class Segmenter:
    ...
    def segment_image(self, resized_image):
        ...
        # categories = segmentation_result.category_mask[0].numpy_view() # img_size x img_size of 0 - num classes
